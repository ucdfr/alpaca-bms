...
*
* Summary:
*   Sets the Priority of the Interrupt. Note calling ADC_current_IRQ_Start
*   or ADC_current_IRQ_StartEx will override any effect this method 
*   would have had. This method should only be called after 
*   ADC_current_IRQ_Start or ADC_current_IRQ_StartEx has been called. To set 
