...
{
    uint8 staticBits = (Pin_reset_DR & (uint8)(~Pin_reset_MASK));
    Pin_reset_DR = staticBits | ((uint8)(value << Pin_reset_SHIFT) & Pin_reset_MASK);
}
...
{
	CyPins_SetPinDriveMode(Pin_reset_0, mode);
}
...
{
    return (Pin_reset_PS & Pin_reset_MASK) >> Pin_reset_SHIFT;
}
...
{
    return (Pin_reset_DR & Pin_reset_MASK) >> Pin_reset_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (Pin_reset_INTSTAT & Pin_reset_MASK) >> Pin_reset_SHIFT;
    }
