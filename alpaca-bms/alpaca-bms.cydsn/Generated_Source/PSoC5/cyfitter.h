...
#define poll__INTC_MASK 0x40u
#define poll__INTC_NUMBER 6u
#define poll__INTC_PRIOR_NUM 7u
#define poll__INTC_PRIOR_REG CYREG_NVIC_PRI_6
...
/* LTC68_BSPIM */
#define LTC68_BSPIM_BitCounter__16BIT_CONTROL_AUX_CTL_REG CYREG_B0_UDB02_03_ACTL
#define LTC68_BSPIM_BitCounter__16BIT_CONTROL_CONTROL_REG CYREG_B0_UDB02_03_CTL
#define LTC68_BSPIM_BitCounter__16BIT_CONTROL_COUNT_REG CYREG_B0_UDB02_03_CTL
#define LTC68_BSPIM_BitCounter__16BIT_COUNT_CONTROL_REG CYREG_B0_UDB02_03_CTL
#define LTC68_BSPIM_BitCounter__16BIT_COUNT_COUNT_REG CYREG_B0_UDB02_03_CTL
#define LTC68_BSPIM_BitCounter__16BIT_MASK_MASK_REG CYREG_B0_UDB02_03_MSK
#define LTC68_BSPIM_BitCounter__16BIT_MASK_PERIOD_REG CYREG_B0_UDB02_03_MSK
#define LTC68_BSPIM_BitCounter__16BIT_PERIOD_MASK_REG CYREG_B0_UDB02_03_MSK
#define LTC68_BSPIM_BitCounter__16BIT_PERIOD_PERIOD_REG CYREG_B0_UDB02_03_MSK
#define LTC68_BSPIM_BitCounter__CONTROL_AUX_CTL_REG CYREG_B0_UDB02_ACTL
#define LTC68_BSPIM_BitCounter__CONTROL_REG CYREG_B0_UDB02_CTL
#define LTC68_BSPIM_BitCounter__CONTROL_ST_REG CYREG_B0_UDB02_ST_CTL
#define LTC68_BSPIM_BitCounter__COUNT_REG CYREG_B0_UDB02_CTL
#define LTC68_BSPIM_BitCounter__COUNT_ST_REG CYREG_B0_UDB02_ST_CTL
#define LTC68_BSPIM_BitCounter__MASK_CTL_AUX_CTL_REG CYREG_B0_UDB02_MSK_ACTL
#define LTC68_BSPIM_BitCounter__PER_CTL_AUX_CTL_REG CYREG_B0_UDB02_MSK_ACTL
#define LTC68_BSPIM_BitCounter__PERIOD_REG CYREG_B0_UDB02_MSK
#define LTC68_BSPIM_BitCounter_ST__16BIT_STATUS_AUX_CTL_REG CYREG_B0_UDB02_03_ACTL
#define LTC68_BSPIM_BitCounter_ST__16BIT_STATUS_REG CYREG_B0_UDB02_03_ST
#define LTC68_BSPIM_BitCounter_ST__MASK_REG CYREG_B0_UDB02_MSK
#define LTC68_BSPIM_BitCounter_ST__MASK_ST_AUX_CTL_REG CYREG_B0_UDB02_MSK_ACTL
#define LTC68_BSPIM_BitCounter_ST__PER_ST_AUX_CTL_REG CYREG_B0_UDB02_MSK_ACTL
#define LTC68_BSPIM_BitCounter_ST__STATUS_AUX_CTL_REG CYREG_B0_UDB02_ACTL
#define LTC68_BSPIM_BitCounter_ST__STATUS_CNT_REG CYREG_B0_UDB02_ST_CTL
#define LTC68_BSPIM_BitCounter_ST__STATUS_CONTROL_REG CYREG_B0_UDB02_ST_CTL
#define LTC68_BSPIM_BitCounter_ST__STATUS_REG CYREG_B0_UDB02_ST
#define LTC68_BSPIM_RxStsReg__16BIT_STATUS_AUX_CTL_REG CYREG_B0_UDB01_02_ACTL
#define LTC68_BSPIM_RxStsReg__16BIT_STATUS_REG CYREG_B0_UDB01_02_ST
...
#define LTC68_BSPIM_RxStsReg__MASK_REG CYREG_B0_UDB01_MSK
#define LTC68_BSPIM_RxStsReg__STATUS_AUX_CTL_REG CYREG_B0_UDB01_ACTL
#define LTC68_BSPIM_RxStsReg__STATUS_REG CYREG_B0_UDB01_ST
...
#define LTC68_BSPIM_sR8_Dp_u0__MSK_DP_AUX_CTL_REG CYREG_B0_UDB02_MSK_ACTL
#define LTC68_BSPIM_sR8_Dp_u0__PER_DP_AUX_CTL_REG CYREG_B0_UDB02_MSK_ACTL
...
#define LTC68_RxInternalInterrupt__INTC_MASK 0x10u
#define LTC68_RxInternalInterrupt__INTC_NUMBER 4u
#define LTC68_RxInternalInterrupt__INTC_PRIOR_NUM 7u
#define LTC68_RxInternalInterrupt__INTC_PRIOR_REG CYREG_NVIC_PRI_4
...
#define LTC68_TxInternalInterrupt__INTC_MASK 0x20u
#define LTC68_TxInternalInterrupt__INTC_NUMBER 5u
#define LTC68_TxInternalInterrupt__INTC_PRIOR_NUM 7u
#define LTC68_TxInternalInterrupt__INTC_PRIOR_REG CYREG_NVIC_PRI_5
...
#define current__0__PC CYREG_PRT3_PC7
#define current__0__PORT 3u
#define current__0__SHIFT 7
#define current__AG CYREG_PRT3_AG
#define current__AMUX CYREG_PRT3_AMUX
#define current__BIE CYREG_PRT3_BIE
#define current__BIT_MASK CYREG_PRT3_BIT_MASK
#define current__BYP CYREG_PRT3_BYP
#define current__CTL CYREG_PRT3_CTL
#define current__DM0 CYREG_PRT3_DM0
#define current__DM1 CYREG_PRT3_DM1
#define current__DM2 CYREG_PRT3_DM2
#define current__DR CYREG_PRT3_DR
#define current__INP_DIS CYREG_PRT3_INP_DIS
#define current__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define current__LCD_EN CYREG_PRT3_LCD_EN
#define current__MASK 0x80u
#define current__PORT 3u
#define current__PRT CYREG_PRT3_PRT
#define current__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define current__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define current__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define current__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define current__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define current__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define current__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define current__PS CYREG_PRT3_PS
#define current__SHIFT 7
...
#define WDT_timer_clock__CFG2 CYREG_CLKDIST_DCFG3_CFG2
#define WDT_timer_clock__CFG2_SRC_SEL_MASK 0x07u
#define WDT_timer_clock__INDEX 0x03u
#define WDT_timer_clock__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define WDT_timer_clock__PM_ACT_MSK 0x08u
#define WDT_timer_clock__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define WDT_timer_clock__PM_STBY_MSK 0x08u
...
/* DEBUG_UART_arb_int */
#define DEBUG_UART_arb_int__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define DEBUG_UART_arb_int__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define DEBUG_UART_arb_int__INTC_MASK 0x400000u
#define DEBUG_UART_arb_int__INTC_NUMBER 22u
#define DEBUG_UART_arb_int__INTC_PRIOR_NUM 7u
#define DEBUG_UART_arb_int__INTC_PRIOR_REG CYREG_NVIC_PRI_22
#define DEBUG_UART_arb_int__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define DEBUG_UART_arb_int__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* DEBUG_UART_bus_reset */
#define DEBUG_UART_bus_reset__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define DEBUG_UART_bus_reset__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define DEBUG_UART_bus_reset__INTC_MASK 0x800000u
#define DEBUG_UART_bus_reset__INTC_NUMBER 23u
#define DEBUG_UART_bus_reset__INTC_PRIOR_NUM 7u
#define DEBUG_UART_bus_reset__INTC_PRIOR_REG CYREG_NVIC_PRI_23
#define DEBUG_UART_bus_reset__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define DEBUG_UART_bus_reset__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* DEBUG_UART_Dm */
#define DEBUG_UART_Dm__0__MASK 0x80u
#define DEBUG_UART_Dm__0__PC CYREG_IO_PC_PRT15_7_6_PC1
#define DEBUG_UART_Dm__0__PORT 15u
#define DEBUG_UART_Dm__0__SHIFT 7
#define DEBUG_UART_Dm__AG CYREG_PRT15_AG
#define DEBUG_UART_Dm__AMUX CYREG_PRT15_AMUX
#define DEBUG_UART_Dm__BIE CYREG_PRT15_BIE
#define DEBUG_UART_Dm__BIT_MASK CYREG_PRT15_BIT_MASK
#define DEBUG_UART_Dm__BYP CYREG_PRT15_BYP
#define DEBUG_UART_Dm__CTL CYREG_PRT15_CTL
#define DEBUG_UART_Dm__DM0 CYREG_PRT15_DM0
#define DEBUG_UART_Dm__DM1 CYREG_PRT15_DM1
#define DEBUG_UART_Dm__DM2 CYREG_PRT15_DM2
#define DEBUG_UART_Dm__DR CYREG_PRT15_DR
#define DEBUG_UART_Dm__INP_DIS CYREG_PRT15_INP_DIS
#define DEBUG_UART_Dm__LCD_COM_SEG CYREG_PRT15_LCD_COM_SEG
#define DEBUG_UART_Dm__LCD_EN CYREG_PRT15_LCD_EN
#define DEBUG_UART_Dm__MASK 0x80u
#define DEBUG_UART_Dm__PORT 15u
#define DEBUG_UART_Dm__PRT CYREG_PRT15_PRT
#define DEBUG_UART_Dm__PRTDSI__CAPS_SEL CYREG_PRT15_CAPS_SEL
#define DEBUG_UART_Dm__PRTDSI__DBL_SYNC_IN CYREG_PRT15_DBL_SYNC_IN
#define DEBUG_UART_Dm__PRTDSI__OE_SEL0 CYREG_PRT15_OE_SEL0
#define DEBUG_UART_Dm__PRTDSI__OE_SEL1 CYREG_PRT15_OE_SEL1
#define DEBUG_UART_Dm__PRTDSI__OUT_SEL0 CYREG_PRT15_OUT_SEL0
#define DEBUG_UART_Dm__PRTDSI__OUT_SEL1 CYREG_PRT15_OUT_SEL1
#define DEBUG_UART_Dm__PRTDSI__SYNC_OUT CYREG_PRT15_SYNC_OUT
#define DEBUG_UART_Dm__PS CYREG_PRT15_PS
#define DEBUG_UART_Dm__SHIFT 7
#define DEBUG_UART_Dm__SLW CYREG_PRT15_SLW

/* DEBUG_UART_Dp */
#define DEBUG_UART_Dp__0__MASK 0x40u
#define DEBUG_UART_Dp__0__PC CYREG_IO_PC_PRT15_7_6_PC0
#define DEBUG_UART_Dp__0__PORT 15u
#define DEBUG_UART_Dp__0__SHIFT 6
#define DEBUG_UART_Dp__AG CYREG_PRT15_AG
#define DEBUG_UART_Dp__AMUX CYREG_PRT15_AMUX
#define DEBUG_UART_Dp__BIE CYREG_PRT15_BIE
#define DEBUG_UART_Dp__BIT_MASK CYREG_PRT15_BIT_MASK
#define DEBUG_UART_Dp__BYP CYREG_PRT15_BYP
#define DEBUG_UART_Dp__CTL CYREG_PRT15_CTL
#define DEBUG_UART_Dp__DM0 CYREG_PRT15_DM0
#define DEBUG_UART_Dp__DM1 CYREG_PRT15_DM1
#define DEBUG_UART_Dp__DM2 CYREG_PRT15_DM2
#define DEBUG_UART_Dp__DR CYREG_PRT15_DR
#define DEBUG_UART_Dp__INP_DIS CYREG_PRT15_INP_DIS
#define DEBUG_UART_Dp__INTSTAT CYREG_PICU15_INTSTAT
#define DEBUG_UART_Dp__LCD_COM_SEG CYREG_PRT15_LCD_COM_SEG
#define DEBUG_UART_Dp__LCD_EN CYREG_PRT15_LCD_EN
#define DEBUG_UART_Dp__MASK 0x40u
#define DEBUG_UART_Dp__PORT 15u
#define DEBUG_UART_Dp__PRT CYREG_PRT15_PRT
#define DEBUG_UART_Dp__PRTDSI__CAPS_SEL CYREG_PRT15_CAPS_SEL
#define DEBUG_UART_Dp__PRTDSI__DBL_SYNC_IN CYREG_PRT15_DBL_SYNC_IN
#define DEBUG_UART_Dp__PRTDSI__OE_SEL0 CYREG_PRT15_OE_SEL0
#define DEBUG_UART_Dp__PRTDSI__OE_SEL1 CYREG_PRT15_OE_SEL1
#define DEBUG_UART_Dp__PRTDSI__OUT_SEL0 CYREG_PRT15_OUT_SEL0
#define DEBUG_UART_Dp__PRTDSI__OUT_SEL1 CYREG_PRT15_OUT_SEL1
#define DEBUG_UART_Dp__PRTDSI__SYNC_OUT CYREG_PRT15_SYNC_OUT
#define DEBUG_UART_Dp__PS CYREG_PRT15_PS
#define DEBUG_UART_Dp__SHIFT 6
#define DEBUG_UART_Dp__SLW CYREG_PRT15_SLW
#define DEBUG_UART_Dp__SNAP CYREG_PICU_15_SNAP_15

/* DEBUG_UART_dp_int */
#define DEBUG_UART_dp_int__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define DEBUG_UART_dp_int__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define DEBUG_UART_dp_int__INTC_MASK 0x1000u
#define DEBUG_UART_dp_int__INTC_NUMBER 12u
#define DEBUG_UART_dp_int__INTC_PRIOR_NUM 7u
#define DEBUG_UART_dp_int__INTC_PRIOR_REG CYREG_NVIC_PRI_12
#define DEBUG_UART_dp_int__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define DEBUG_UART_dp_int__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* DEBUG_UART_ep_0 */
#define DEBUG_UART_ep_0__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define DEBUG_UART_ep_0__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define DEBUG_UART_ep_0__INTC_MASK 0x1000000u
#define DEBUG_UART_ep_0__INTC_NUMBER 24u
#define DEBUG_UART_ep_0__INTC_PRIOR_NUM 7u
#define DEBUG_UART_ep_0__INTC_PRIOR_REG CYREG_NVIC_PRI_24
#define DEBUG_UART_ep_0__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define DEBUG_UART_ep_0__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* DEBUG_UART_ep_1 */
#define DEBUG_UART_ep_1__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define DEBUG_UART_ep_1__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define DEBUG_UART_ep_1__INTC_MASK 0x02u
#define DEBUG_UART_ep_1__INTC_NUMBER 1u
#define DEBUG_UART_ep_1__INTC_PRIOR_NUM 7u
#define DEBUG_UART_ep_1__INTC_PRIOR_REG CYREG_NVIC_PRI_1
#define DEBUG_UART_ep_1__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define DEBUG_UART_ep_1__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* DEBUG_UART_ep_2 */
#define DEBUG_UART_ep_2__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define DEBUG_UART_ep_2__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define DEBUG_UART_ep_2__INTC_MASK 0x04u
#define DEBUG_UART_ep_2__INTC_NUMBER 2u
#define DEBUG_UART_ep_2__INTC_PRIOR_NUM 7u
#define DEBUG_UART_ep_2__INTC_PRIOR_REG CYREG_NVIC_PRI_2
#define DEBUG_UART_ep_2__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define DEBUG_UART_ep_2__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* DEBUG_UART_ep_3 */
#define DEBUG_UART_ep_3__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define DEBUG_UART_ep_3__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define DEBUG_UART_ep_3__INTC_MASK 0x08u
#define DEBUG_UART_ep_3__INTC_NUMBER 3u
#define DEBUG_UART_ep_3__INTC_PRIOR_NUM 7u
#define DEBUG_UART_ep_3__INTC_PRIOR_REG CYREG_NVIC_PRI_3
#define DEBUG_UART_ep_3__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define DEBUG_UART_ep_3__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* DEBUG_UART_sof_int */
#define DEBUG_UART_sof_int__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define DEBUG_UART_sof_int__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define DEBUG_UART_sof_int__INTC_MASK 0x200000u
#define DEBUG_UART_sof_int__INTC_NUMBER 21u
#define DEBUG_UART_sof_int__INTC_PRIOR_NUM 7u
#define DEBUG_UART_sof_int__INTC_PRIOR_REG CYREG_NVIC_PRI_21
#define DEBUG_UART_sof_int__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define DEBUG_UART_sof_int__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* DEBUG_UART_USB */
#define DEBUG_UART_USB__ARB_CFG CYREG_USB_ARB_CFG
#define DEBUG_UART_USB__ARB_EP1_CFG CYREG_USB_ARB_EP1_CFG
#define DEBUG_UART_USB__ARB_EP1_INT_EN CYREG_USB_ARB_EP1_INT_EN
#define DEBUG_UART_USB__ARB_EP1_SR CYREG_USB_ARB_EP1_SR
#define DEBUG_UART_USB__ARB_EP2_CFG CYREG_USB_ARB_EP2_CFG
#define DEBUG_UART_USB__ARB_EP2_INT_EN CYREG_USB_ARB_EP2_INT_EN
#define DEBUG_UART_USB__ARB_EP2_SR CYREG_USB_ARB_EP2_SR
#define DEBUG_UART_USB__ARB_EP3_CFG CYREG_USB_ARB_EP3_CFG
#define DEBUG_UART_USB__ARB_EP3_INT_EN CYREG_USB_ARB_EP3_INT_EN
#define DEBUG_UART_USB__ARB_EP3_SR CYREG_USB_ARB_EP3_SR
#define DEBUG_UART_USB__ARB_EP4_CFG CYREG_USB_ARB_EP4_CFG
#define DEBUG_UART_USB__ARB_EP4_INT_EN CYREG_USB_ARB_EP4_INT_EN
#define DEBUG_UART_USB__ARB_EP4_SR CYREG_USB_ARB_EP4_SR
#define DEBUG_UART_USB__ARB_EP5_CFG CYREG_USB_ARB_EP5_CFG
#define DEBUG_UART_USB__ARB_EP5_INT_EN CYREG_USB_ARB_EP5_INT_EN
#define DEBUG_UART_USB__ARB_EP5_SR CYREG_USB_ARB_EP5_SR
#define DEBUG_UART_USB__ARB_EP6_CFG CYREG_USB_ARB_EP6_CFG
#define DEBUG_UART_USB__ARB_EP6_INT_EN CYREG_USB_ARB_EP6_INT_EN
#define DEBUG_UART_USB__ARB_EP6_SR CYREG_USB_ARB_EP6_SR
#define DEBUG_UART_USB__ARB_EP7_CFG CYREG_USB_ARB_EP7_CFG
#define DEBUG_UART_USB__ARB_EP7_INT_EN CYREG_USB_ARB_EP7_INT_EN
#define DEBUG_UART_USB__ARB_EP7_SR CYREG_USB_ARB_EP7_SR
#define DEBUG_UART_USB__ARB_EP8_CFG CYREG_USB_ARB_EP8_CFG
#define DEBUG_UART_USB__ARB_EP8_INT_EN CYREG_USB_ARB_EP8_INT_EN
#define DEBUG_UART_USB__ARB_EP8_SR CYREG_USB_ARB_EP8_SR
#define DEBUG_UART_USB__ARB_INT_EN CYREG_USB_ARB_INT_EN
#define DEBUG_UART_USB__ARB_INT_SR CYREG_USB_ARB_INT_SR
#define DEBUG_UART_USB__ARB_RW1_DR CYREG_USB_ARB_RW1_DR
#define DEBUG_UART_USB__ARB_RW1_RA CYREG_USB_ARB_RW1_RA
#define DEBUG_UART_USB__ARB_RW1_RA_MSB CYREG_USB_ARB_RW1_RA_MSB
#define DEBUG_UART_USB__ARB_RW1_WA CYREG_USB_ARB_RW1_WA
#define DEBUG_UART_USB__ARB_RW1_WA_MSB CYREG_USB_ARB_RW1_WA_MSB
#define DEBUG_UART_USB__ARB_RW2_DR CYREG_USB_ARB_RW2_DR
#define DEBUG_UART_USB__ARB_RW2_RA CYREG_USB_ARB_RW2_RA
#define DEBUG_UART_USB__ARB_RW2_RA_MSB CYREG_USB_ARB_RW2_RA_MSB
#define DEBUG_UART_USB__ARB_RW2_WA CYREG_USB_ARB_RW2_WA
#define DEBUG_UART_USB__ARB_RW2_WA_MSB CYREG_USB_ARB_RW2_WA_MSB
#define DEBUG_UART_USB__ARB_RW3_DR CYREG_USB_ARB_RW3_DR
#define DEBUG_UART_USB__ARB_RW3_RA CYREG_USB_ARB_RW3_RA
#define DEBUG_UART_USB__ARB_RW3_RA_MSB CYREG_USB_ARB_RW3_RA_MSB
#define DEBUG_UART_USB__ARB_RW3_WA CYREG_USB_ARB_RW3_WA
#define DEBUG_UART_USB__ARB_RW3_WA_MSB CYREG_USB_ARB_RW3_WA_MSB
#define DEBUG_UART_USB__ARB_RW4_DR CYREG_USB_ARB_RW4_DR
#define DEBUG_UART_USB__ARB_RW4_RA CYREG_USB_ARB_RW4_RA
#define DEBUG_UART_USB__ARB_RW4_RA_MSB CYREG_USB_ARB_RW4_RA_MSB
#define DEBUG_UART_USB__ARB_RW4_WA CYREG_USB_ARB_RW4_WA
#define DEBUG_UART_USB__ARB_RW4_WA_MSB CYREG_USB_ARB_RW4_WA_MSB
#define DEBUG_UART_USB__ARB_RW5_DR CYREG_USB_ARB_RW5_DR
#define DEBUG_UART_USB__ARB_RW5_RA CYREG_USB_ARB_RW5_RA
#define DEBUG_UART_USB__ARB_RW5_RA_MSB CYREG_USB_ARB_RW5_RA_MSB
#define DEBUG_UART_USB__ARB_RW5_WA CYREG_USB_ARB_RW5_WA
#define DEBUG_UART_USB__ARB_RW5_WA_MSB CYREG_USB_ARB_RW5_WA_MSB
#define DEBUG_UART_USB__ARB_RW6_DR CYREG_USB_ARB_RW6_DR
#define DEBUG_UART_USB__ARB_RW6_RA CYREG_USB_ARB_RW6_RA
#define DEBUG_UART_USB__ARB_RW6_RA_MSB CYREG_USB_ARB_RW6_RA_MSB
#define DEBUG_UART_USB__ARB_RW6_WA CYREG_USB_ARB_RW6_WA
#define DEBUG_UART_USB__ARB_RW6_WA_MSB CYREG_USB_ARB_RW6_WA_MSB
#define DEBUG_UART_USB__ARB_RW7_DR CYREG_USB_ARB_RW7_DR
#define DEBUG_UART_USB__ARB_RW7_RA CYREG_USB_ARB_RW7_RA
#define DEBUG_UART_USB__ARB_RW7_RA_MSB CYREG_USB_ARB_RW7_RA_MSB
#define DEBUG_UART_USB__ARB_RW7_WA CYREG_USB_ARB_RW7_WA
#define DEBUG_UART_USB__ARB_RW7_WA_MSB CYREG_USB_ARB_RW7_WA_MSB
#define DEBUG_UART_USB__ARB_RW8_DR CYREG_USB_ARB_RW8_DR
#define DEBUG_UART_USB__ARB_RW8_RA CYREG_USB_ARB_RW8_RA
#define DEBUG_UART_USB__ARB_RW8_RA_MSB CYREG_USB_ARB_RW8_RA_MSB
#define DEBUG_UART_USB__ARB_RW8_WA CYREG_USB_ARB_RW8_WA
#define DEBUG_UART_USB__ARB_RW8_WA_MSB CYREG_USB_ARB_RW8_WA_MSB
#define DEBUG_UART_USB__BUF_SIZE CYREG_USB_BUF_SIZE
#define DEBUG_UART_USB__BUS_RST_CNT CYREG_USB_BUS_RST_CNT
#define DEBUG_UART_USB__CR0 CYREG_USB_CR0
#define DEBUG_UART_USB__CR1 CYREG_USB_CR1
#define DEBUG_UART_USB__CWA CYREG_USB_CWA
#define DEBUG_UART_USB__CWA_MSB CYREG_USB_CWA_MSB
#define DEBUG_UART_USB__DMA_THRES CYREG_USB_DMA_THRES
#define DEBUG_UART_USB__DMA_THRES_MSB CYREG_USB_DMA_THRES_MSB
#define DEBUG_UART_USB__DYN_RECONFIG CYREG_USB_DYN_RECONFIG
#define DEBUG_UART_USB__EP_ACTIVE CYREG_USB_EP_ACTIVE
#define DEBUG_UART_USB__EP_TYPE CYREG_USB_EP_TYPE
#define DEBUG_UART_USB__EP0_CNT CYREG_USB_EP0_CNT
#define DEBUG_UART_USB__EP0_CR CYREG_USB_EP0_CR
#define DEBUG_UART_USB__EP0_DR0 CYREG_USB_EP0_DR0
#define DEBUG_UART_USB__EP0_DR1 CYREG_USB_EP0_DR1
#define DEBUG_UART_USB__EP0_DR2 CYREG_USB_EP0_DR2
#define DEBUG_UART_USB__EP0_DR3 CYREG_USB_EP0_DR3
#define DEBUG_UART_USB__EP0_DR4 CYREG_USB_EP0_DR4
#define DEBUG_UART_USB__EP0_DR5 CYREG_USB_EP0_DR5
#define DEBUG_UART_USB__EP0_DR6 CYREG_USB_EP0_DR6
#define DEBUG_UART_USB__EP0_DR7 CYREG_USB_EP0_DR7
#define DEBUG_UART_USB__MEM_DATA CYREG_USB_MEM_DATA_MBASE
#define DEBUG_UART_USB__PM_ACT_CFG CYREG_PM_ACT_CFG5
#define DEBUG_UART_USB__PM_ACT_MSK 0x01u
#define DEBUG_UART_USB__PM_STBY_CFG CYREG_PM_STBY_CFG5
#define DEBUG_UART_USB__PM_STBY_MSK 0x01u
#define DEBUG_UART_USB__SIE_EP_INT_EN CYREG_USB_SIE_EP_INT_EN
#define DEBUG_UART_USB__SIE_EP_INT_SR CYREG_USB_SIE_EP_INT_SR
#define DEBUG_UART_USB__SIE_EP1_CNT0 CYREG_USB_SIE_EP1_CNT0
#define DEBUG_UART_USB__SIE_EP1_CNT1 CYREG_USB_SIE_EP1_CNT1
#define DEBUG_UART_USB__SIE_EP1_CR0 CYREG_USB_SIE_EP1_CR0
#define DEBUG_UART_USB__SIE_EP2_CNT0 CYREG_USB_SIE_EP2_CNT0
#define DEBUG_UART_USB__SIE_EP2_CNT1 CYREG_USB_SIE_EP2_CNT1
#define DEBUG_UART_USB__SIE_EP2_CR0 CYREG_USB_SIE_EP2_CR0
#define DEBUG_UART_USB__SIE_EP3_CNT0 CYREG_USB_SIE_EP3_CNT0
#define DEBUG_UART_USB__SIE_EP3_CNT1 CYREG_USB_SIE_EP3_CNT1
#define DEBUG_UART_USB__SIE_EP3_CR0 CYREG_USB_SIE_EP3_CR0
#define DEBUG_UART_USB__SIE_EP4_CNT0 CYREG_USB_SIE_EP4_CNT0
#define DEBUG_UART_USB__SIE_EP4_CNT1 CYREG_USB_SIE_EP4_CNT1
#define DEBUG_UART_USB__SIE_EP4_CR0 CYREG_USB_SIE_EP4_CR0
#define DEBUG_UART_USB__SIE_EP5_CNT0 CYREG_USB_SIE_EP5_CNT0
#define DEBUG_UART_USB__SIE_EP5_CNT1 CYREG_USB_SIE_EP5_CNT1
#define DEBUG_UART_USB__SIE_EP5_CR0 CYREG_USB_SIE_EP5_CR0
#define DEBUG_UART_USB__SIE_EP6_CNT0 CYREG_USB_SIE_EP6_CNT0
#define DEBUG_UART_USB__SIE_EP6_CNT1 CYREG_USB_SIE_EP6_CNT1
#define DEBUG_UART_USB__SIE_EP6_CR0 CYREG_USB_SIE_EP6_CR0
#define DEBUG_UART_USB__SIE_EP7_CNT0 CYREG_USB_SIE_EP7_CNT0
#define DEBUG_UART_USB__SIE_EP7_CNT1 CYREG_USB_SIE_EP7_CNT1
#define DEBUG_UART_USB__SIE_EP7_CR0 CYREG_USB_SIE_EP7_CR0
#define DEBUG_UART_USB__SIE_EP8_CNT0 CYREG_USB_SIE_EP8_CNT0
#define DEBUG_UART_USB__SIE_EP8_CNT1 CYREG_USB_SIE_EP8_CNT1
#define DEBUG_UART_USB__SIE_EP8_CR0 CYREG_USB_SIE_EP8_CR0
#define DEBUG_UART_USB__SOF0 CYREG_USB_SOF0
#define DEBUG_UART_USB__SOF1 CYREG_USB_SOF1
#define DEBUG_UART_USB__USB_CLK_EN CYREG_USB_USB_CLK_EN
#define DEBUG_UART_USB__USBIO_CR0 CYREG_USB_USBIO_CR0
#define DEBUG_UART_USB__USBIO_CR1 CYREG_USB_USBIO_CR1
...
/* Can_Update_ISR */
#define Can_Update_ISR__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define Can_Update_ISR__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define Can_Update_ISR__INTC_MASK 0x20000u
#define Can_Update_ISR__INTC_NUMBER 17u
#define Can_Update_ISR__INTC_PRIOR_NUM 7u
#define Can_Update_ISR__INTC_PRIOR_REG CYREG_NVIC_PRI_17
#define Can_Update_ISR__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define Can_Update_ISR__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* Can_Update_Timer_TimerHW */
#define Can_Update_Timer_TimerHW__CAP0 CYREG_TMR0_CAP0
#define Can_Update_Timer_TimerHW__CAP1 CYREG_TMR0_CAP1
#define Can_Update_Timer_TimerHW__CFG0 CYREG_TMR0_CFG0
#define Can_Update_Timer_TimerHW__CFG1 CYREG_TMR0_CFG1
#define Can_Update_Timer_TimerHW__CFG2 CYREG_TMR0_CFG2
#define Can_Update_Timer_TimerHW__CNT_CMP0 CYREG_TMR0_CNT_CMP0
#define Can_Update_Timer_TimerHW__CNT_CMP1 CYREG_TMR0_CNT_CMP1
#define Can_Update_Timer_TimerHW__PER0 CYREG_TMR0_PER0
#define Can_Update_Timer_TimerHW__PER1 CYREG_TMR0_PER1
#define Can_Update_Timer_TimerHW__PM_ACT_CFG CYREG_PM_ACT_CFG3
#define Can_Update_Timer_TimerHW__PM_ACT_MSK 0x01u
#define Can_Update_Timer_TimerHW__PM_STBY_CFG CYREG_PM_STBY_CFG3
#define Can_Update_Timer_TimerHW__PM_STBY_MSK 0x01u
#define Can_Update_Timer_TimerHW__RT0 CYREG_TMR0_RT0
#define Can_Update_Timer_TimerHW__RT1 CYREG_TMR0_RT1
#define Can_Update_Timer_TimerHW__SR0 CYREG_TMR0_SR0
