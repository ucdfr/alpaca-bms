...
{
    uint8 staticBits = (Pin_MOSI_DR & (uint8)(~Pin_MOSI_MASK));
    Pin_MOSI_DR = staticBits | ((uint8)(value << Pin_MOSI_SHIFT) & Pin_MOSI_MASK);
}
...
{
	CyPins_SetPinDriveMode(Pin_MOSI_0, mode);
}
...
{
    return (Pin_MOSI_PS & Pin_MOSI_MASK) >> Pin_MOSI_SHIFT;
}
...
{
    return (Pin_MOSI_DR & Pin_MOSI_MASK) >> Pin_MOSI_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (Pin_MOSI_INTSTAT & Pin_MOSI_MASK) >> Pin_MOSI_SHIFT;
    }
